 ...
 * interface.
 */
public class FeedListFragment extends ListFragment implements FeedProviderIO.DatabaseListeners {
    ...
    public void onListItemClick(ListView listView, View view, int position, long id) {
        ...
        mCallbacks.onItemSelected(DummyContent.ITEMS.get(position).id, rssProviderList.get(position));
    }
